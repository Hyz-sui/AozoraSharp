    ...
    new(myProfile.Labels))
{
    ...
    public async Task<AozoraMyPost> CreatePostAsync(string text, ICollection<string> langs, IEmbed embed = null, DateTime createdAt = default, CancellationToken cancellationToken = default)
    {
        logger.Debug("Creating post");
        var httpPost = new Post(text, createdAt == default ? DateTime.UtcNow : createdAt, langs, embed, Via: Client.Option.PostVia);
        var request = new CreatePostRequest(Did, ATTypeName.FeedPost, httpPost);
    ...
    /// <param name="collection">Record type.<br/>Normally, you don't have to change this.</param>
    /// <returns>created post</returns>
    public async Task<AozoraMyPost> CreatePostAsync(string text, ICollection<string> langs, IReadOnlyList<ImageInfo> images, DateTime createdAt = default, CancellationToken cancellationToken = default)
    {
        var embed = await UploadImagesAsync(images, cancellationToken);
        return await CreatePostAsync(text, langs, embed, createdAt, cancellationToken);
    }
    /// <summary>
    /// Create a quote post.
    /// </summary>
    ...
    /// <param name="collection">Record type.<br/>Normally, you don't have to change this.</param>
    /// <returns>created post</returns>
    public async Task<AozoraMyPost> CreatePostAsync(string text, ICollection<string> langs, AozoraPost postToQuote, DateTime createdAt = default, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="collection">Record type.<br/>Normally, you don't have to change this.</param>
    /// <returns>created post</returns>
    public async Task<AozoraMyPost> CreatePostAsync(string text, ICollection<string> langs, string uri, DateTime createdAt = default, CancellationToken cancellationToken = default)
    {
        var externalInfo = await WebUtility.FetchExternalInfoFromUriAsync(uri, Client.HttpClient);
        return await CreatePostAsync(text, langs, externalInfo, createdAt, cancellationToken);
    }
    /// <summary>
    ...
    /// <param name="collection">Record type.<br/>Normally, you don't have to change this.</param>
    /// <returns>created post</returns>
    public async Task<AozoraMyPost> CreatePostAsync(string text, ICollection<string> langs, ExternalInfo externalInfo, DateTime createdAt = default, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="collection">Record type.<br/>Normally, you don't have to change this.</param>
    /// <returns>created post</returns>
    public async Task<AozoraMyPost> CreatePostAsync(string text, ICollection<string> langs, string uri, AozoraPost postToQuote, DateTime createdAt = default, CancellationToken cancellationToken = default)
    {
        var externalInfo = await WebUtility.FetchExternalInfoFromUriAsync(uri, Client.HttpClient);
        return await CreatePostAsync(text, langs, externalInfo, postToQuote, createdAt, cancellationToken);
    }
    /// <summary>
    ...
    /// <param name="collection">Record type.<br/>Normally, you don't have to change this.</param>
    /// <returns>created post</returns>
    public async Task<AozoraMyPost> CreatePostAsync(string text, ICollection<string> langs, ExternalInfo externalInfo, AozoraPost postToQuote, DateTime createdAt = default, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="collection">Record type.<br/>Normally, you don't have to change this.</param>
    /// <returns>created post</returns>
    public async Task<AozoraMyPost> CreatePostAsync(string text, ICollection<string> langs, IReadOnlyList<ImageInfo> images, AozoraPost postToQuote, DateTime createdAt = default, CancellationToken cancellationToken = default)
    {
        var embedRecord = new EmbedRecord(new(postToQuote.Uri, postToQuote.Cid));
    ...
    internal async Task<AozoraMyPost> CreateReplyAsync(AozoraPost parent, AozoraPost root, string text, ICollection<string> langs, IEmbed embed = null, DateTime createdAt = default, CancellationToken cancellationToken = default)
    {
